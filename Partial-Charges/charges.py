...
log_files = [
    ...
    os.path.join(os.getcwd(), 'tune_ff-elec-v.log'),
    os.path.join(os.getcwd(), 'tune_ff-allelec-n.log'),
...
output_dir = os.path.join(os.getcwd(), 'combined_data')

if not os.path.exists(output_dir):
    os.makedirs(output_dir)

data = extract_data_from_log(log_files)
save_data_as_latex(data, output_dir)
